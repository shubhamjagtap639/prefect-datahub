...
class DatahubBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_datahub import DatahubBlock
        block = DatahubBlock.load("BLOCK_NAME")
        ```
    """

    _block_type_name = "datahub"
    ...
    _documentation_url = "https://shubhamjagtap639.github.io/prefect-datahub/blocks/#prefect-datahub.blocks.DatahubBlock"  # noqa
