...
async def mock_task_run(*args, **kwargs):
    if args[0] == "fa14a52b-d271-4c41-99cb-6b42ca7c070b":
        return TaskRun.parse_obj(mock_extract_task_run_json)
    elif args[0] == "dd15ee83-5d28-4bf1-804f-f84eab9f9fb7":
        return TaskRun.parse_obj(mock_transform_task_run_json)
    elif args[0] == "f19f83ea-316f-4781-8cbe-1d5d8719afc3":
...
def mock_prefect_cloud_client():
    ...
    with patch(
        "prefect_datahub.datahub_emitter.cloud"
    ) as mock_client, patch(
        "prefect_datahub.datahub_emitter.PREFECT_API_URL.value",
        return_value = "https://api.prefect.cloud/api/accounts/33e98cfe-ad06-4ceb-a500-c11148499f75/workspaces/157eb822-1b3b-4338-ae80-98edd5d00cb9"
    ):
